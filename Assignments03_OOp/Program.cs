...
namespace Assignments03_OOp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            #region 3.Design a program for a library management system where
            //EBook ebook = new EBook("C# ", "Mikle", "01010101", 5.4);
            //PrintedBook printedBook = new PrintedBook("OOP ", "Ali", "000000", 350);

            //Book[] books = { ebook, printedBook };
